...
SECRET_KEY = "django-insecure-xe5)=ra5nk(!$6%dgqrdz54#ue4canh@n-+^5mw$p)-wum9yzw"
...
INSTALLED_APPS = [
    ...
    "debug_toolbar",
    "captcha",
    "animals.apps.AnimalsConfig",  # регистрация приложения apps.py
]
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.path.join(BASE_DIR, "first.site_cache"),
    }
}
